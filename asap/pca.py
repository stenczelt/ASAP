            ...
            for i, frame in enumerate(frames):
                ...
                if fmat in frame.info:
                    try:
                        ...
                        if (ndesc > 0 and len(frame.info[fmat]) != ndesc): raise ValueError(
                            'mismatch of number of descriptors between frames')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-colors', type=str, default='none',
                        help='Location of a file or name of the tags in ase xyz file. It should contain properties '
                             'for all samples (N floats) used to color the scatter plot')
